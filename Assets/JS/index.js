...
var l = document.getElementById("forward");
function play() {
    ...
    if ((x.style.display === 'none') || (no.style.display === "block")) {
...
function hide() {
    ...
    b.pause();
    var hideDiv = document.getElementById('boy-animate');
    var hideDiv1 = document.getElementById('HideDive1');
